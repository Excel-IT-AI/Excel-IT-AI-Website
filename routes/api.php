...
use App\Http\Controllers\Frontend\OrganogramController as FrontendOrganogramController;
...
Route::prefix('admin')->middleware(['auth:sanctum'])->group(function () {
   ...
   //management team routes
    Route::prefix('media')->group(function () {
        ...
        Route::get('/show/{media}',[MediaController::class,'show']);
   ...
   //organogram team routes
    Route::prefix('organogram')->group(function () {
        Route::get('list',[OrganogramController::class,'index']);
        Route::get('/show/{organogram}',[OrganogramController::class,'show']);
        Route::post('/store',[OrganogramController::class,'store']);
        Route::post('/update/{organogram}',[OrganogramController::class,'update']);
        Route::delete('/delete/{organogram}',[OrganogramController::class,'destroy']);
    }); //end organogram routes
...
Route::get('/organogram',[FrontendOrganogramController::class,'getOrganogram']);
Route::post('/user/login',[LoginController::class,'login']);
Route::get('/media/list/frontend',[FrontendMediaController::class,'index']);
